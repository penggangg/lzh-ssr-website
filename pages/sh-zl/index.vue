<template>
  <div>
    ...
    <search :getDistrict="getDistrict" :getBizcircle="getBizcircle"></search>
    <!-- 房源列表 -->
      ...
      <div class="container">
        <ul>
          <li class="contList clearfix" v-for="(house, index) in getHouseList.list" :key="index">
            <a :href="'/sh-zl/'+house.housedelId+'.html'" target="_blank" class="listImg">
            ...
            <div class="clearfix">
              <div class="leftSize">
                <h3>
                  <a :href="'/sh-zl/'+house.housedelId+'.html'" target="_blank" :title="house.houseTitle">{{house.houseTitle}}</a>
                </h3>
                <ul class="secondListShow">
                  ...
                  <li>
                    ...
                    <a :href="'/sh-zl/'+house.housedelId+'.html'" target="_blank">
                      楼盘：<i v-if="house.resblockName">{{house.resblockName}}</i>
                    </a>
                    <a :href="'/sh-zl/'+house.districtId+'_'+house.bizcircleId">
